...
export const certifications: readonly Certification[] = [
  { name: "Professional Cloud Architect", issuer: "Google Cloud", year: "2022" },
  { name: "Professional Data Engineer", issuer: "Google Cloud", year: "2022" },
  { name: "Professional Cloud Developer", issuer: "Google Cloud" },
  { name: "Professional Cloud DevOps Engineer", issuer: "Google Cloud", year: "2023" },
  { name: "Professional Cloud Database Engineer", issuer: "Google Cloud", year: "2023" },
  { name: "Associate Cloud Engineer", issuer: "Google Cloud", year: "2022" },
  { name: "Cloud Digital Leader", issuer: "Google Cloud", year: "2023" },
  { name: "Generative AI Leader", issuer: "Google Cloud" },
  { name: "AWS Certified Data Engineer", issuer: "Amazon Web Services", year: "2025" },
  ...
  { name: "AWS Certified Database – Specialty", issuer: "Amazon Web Services", year: "2023" },
  { name: "AWS Certified Cloud Practitioner", issuer: "Amazon Web Services", year: "2022" },
  { name: "MCSE: Data Management and Analytics", issuer: "Microsoft", year: "2019" },
  { name: "MCSA: SQL 2016 Database Development", issuer: "Microsoft", year: "2019" },
  { name: "Azure Data Fundamentals", issuer: "Microsoft", year: "2024" },
  { name: "Azure Fundamentals", issuer: "Microsoft", year: "2024" },
  { name: "Databricks Certified Data Engineer", issuer: "Databricks", year: "2025" },
  { name: "Neo4j Certified Professional", issuer: "Neo4j", year: "2024" },
